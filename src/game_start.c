...
static int GameStartRowanIntro_Init(ApplicationManager *ovyManager, int *state);
static int GameStartRowanIntro_Main(ApplicationManager *ovyManager, int *state);
static int GameStartRowanIntro_Exit(ApplicationManager *ovyManager, int *state);
static int GameStartNewSave_Init(ApplicationManager *ovyManager, int *state);
static int GameStartNewSave_Main(ApplicationManager *ovyManager, int *state);
static int GameStartNewSave_Exit(ApplicationManager *ovyManager, int *state);
static int GameStartLoadSave_Init(ApplicationManager *ovyManager, int *state);
static int GameStartLoadSave_Main(ApplicationManager *ovyManager, int *state);
static int GameStartLoadSave_Exit(ApplicationManager *ovyManager, int *state);
...
static BOOL GameStartRowanIntro_Init(ApplicationManager *ovyManager, int *state)
{
...
static BOOL GameStartRowanIntro_Main(ApplicationManager *ovyManager, int *state)
{
