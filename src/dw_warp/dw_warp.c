...
BOOL DWWarp_Init(ApplicationManager *appMan, int *state)
{
    ...
    DistortionWorldWarp *dww = OverlayManager_NewData(appMan, sizeof(DistortionWorldWarp), HEAP_ID_DISTORTION_WORLD_WARP);
...
{
    DistortionWorldWarp *warp = OverlayManager_Data(appMan);
