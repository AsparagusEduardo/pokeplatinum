...
{
    return SaveData_BattleFrontierStageInternal(saveData, heapID, resultCode);
}
...
BOOL sub_020309A0(SaveData *saveData, int param1, int param2, int param3, int param4, int heapID, int *param6, int *param7)
{
    ...
    *param7 = 2;
    ...
    v1 = SaveData_BattleFrontierStage(saveData, heapID, param6);
