...
static void ov7_0224B8DC(UnkStruct_ov7_0224B4E8 *param0)
{
    ...
    v2 = String_New((90 * 2), HEAP_ID_FIELD);
    v3 = String_New((90 * 2), HEAP_ID_FIELD);
    v4 = &param0->unk_24;
...
static UnkStruct_ov7_0224B4E8 *ov7_0224BE10(FieldSystem *fieldSystem)
{
    ...
    v0->unk_14 = String_New((90 * 2), HEAP_ID_FIELD);
    v0->unk_18 = String_New((90 * 2), HEAP_ID_FIELD);
    v0->unk_1C = String_New((90 * 2), HEAP_ID_FIELD);
    v0->unk_20 = String_New((90 * 2), HEAP_ID_FIELD);
