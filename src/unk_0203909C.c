...
{
    int v0;
    DWCUserData *v1 = sub_0202AD28(sub_0202B370(saveData));
    DWCFriendData *v2 = sub_0202AED8(sub_0202B370(saveData), 0);
...
BOOL sub_020391DC(SaveData *saveData, int *param1, int param2)
{
    int v0, v1 = 0, v2;
    DWCFriendData *v3 = sub_0202AED8(sub_0202B370(saveData), 0);
    DWCFriendData *v4;
    ...
    for (v0 = 0; v0 < CommSys_ConnectedCount(); v0++) {
        ...
        if (param1[v0] == 0) {
            sub_02039298(saveData, v0, v2, param2, 2);
            CommInfo_SavePlayerRecord(saveData);
        } else if (param1[v0] == 1) {
            if (!sub_020389B8()) {
                sub_02039298(saveData, v0, v2, param2, 1);
...
void sub_02039298(SaveData *saveData, int param1, int param2, int param3, int param4)
{
...
int sub_02039390(SaveData *saveData, int param1)
{
    ...
    UnkStruct_0202B370 *v3 = sub_0202B370(saveData);
