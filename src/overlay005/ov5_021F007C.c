...
static BOOL ov5_021F03D8 (UnkStruct_0203CDB0 *param0)
{
    ...
    v1 = ov5_021D5FE0(param0->unk_04->unk_0C);
...
BOOL ov5_021F0488 (UnkStruct_020508D4 *param0)
{
    ...
    switch (v1->unk_0C) {
    case 0:
        if (ov5_021F0438(v0) == 1) {
            v1->unk_0C = 1;
            v1->unk_08 = ov5_021F03D8(v0);
            v1->unk_04 = ov5_021F0408(v0);
    ...
    case 1:
        if (v1->unk_08 == 0) {
            v1->unk_00 = ov5_021F01F0(v0);
        } else {
            v1->unk_00 = ov5_021F022C(v0);
        }
            ...
            if (v1->unk_0E < 0) {
                {
                    ...
                    v4 = sub_0205EABC(v0->unk_3C);
                    v5 = sub_0205EAC8(v0->unk_3C);
    ...
    case 4:
        ...
        if (v1->unk_08 == 0) {
            v1->unk_00 = ov5_021F0204(v0);
        } else {
            v1->unk_00 = ov5_021F0240(v0);
        }
