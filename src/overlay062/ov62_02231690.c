...
static void ov62_022349E4(UnkStruct_02023790 *param0, int param1);
...
void ov62_022317CC (UnkStruct_0208C06C *param0, int param1)
{
    ...
    sub_02003050(v0, 162, ov62_02231710(param0, 0), 102, 0, 0x20, 14 * 16);
    sub_02003050(v0, 162, ov62_02231710(param0, 0), 102, 1, 0x20, 14 * 16);
...
void ov62_022324A0 (UnkStruct_ov62_02233310 *param0, UnkStruct_0208C06C * param1, const UnkStruct_ov62_02248CDC * param2)
{
    ...
    sub_0201A7A0(v1);
    sub_0201A7E8(param1->unk_14.unk_10, v1, param2->unk_20, param2->unk_0C, param2->unk_10, param2->unk_14, param2->unk_18, 14, param2->unk_1C);
    sub_0201ADA4(v1, 0x0);
...
void ov62_02232594 (UnkStruct_ov62_02233310 *param0, UnkStruct_0208C06C * param1, UnkStruct_0200B144 * param2, const UnkStruct_ov62_02248CDC * param3)
{
    ...
    sub_0201A7A0(v1);
    sub_0201A7E8(param1->unk_14.unk_10, v1, param3->unk_20, param3->unk_0C, param3->unk_10, param3->unk_14, param3->unk_18, 14, param3->unk_1C);
    sub_0201ADA4(v1, 0x0);
    ...
    if (param3->unk_00) {
        ...
        for (v0 = 0; v0 < param0->unk_10; v0++) {
            ...
            v5 = sub_02023790(255, 102);
            v6 = sub_0200B1EC(param1->unk_14.unk_34, 99);

            sub_020238A0(v5, (v0 + 1), 2, 1, 1);
            sub_02023D28(v4, param1->unk_8B4.unk_1D58[v0]->unk_00.unk_00);
...
asm void ov62_02232778 (UnkStruct_ov62_02233310 *param0, UnkStruct_0208C06C * param1, UnkStruct_0200B144 * param2, const UnkStruct_ov62_02248CDC * param3, int param4, int param5, UnkStruct_02023790 * param6)
{
    push {r4, r5, r6, r7, lr}
    sub sp, #0x1fc
    sub sp, #0xe0
...
asm int ov62_02232C78 (UnkStruct_ov62_02233310 *param0, UnkStruct_0208C06C * param1, int param2, int param3, UnkStruct_02023790 * param4)
{
    push {r4, r5, r6, r7, lr}
    sub sp, #0x1fc
    sub sp, #0xe8
...
int ov62_02233064 (UnkStruct_ov62_02233310 *param0, UnkStruct_0208C06C * param1)
{
...

    {
        ...
        for (v4 = 0; v4 < param0->unk_10; v4++) {
            v7 = sub_02023790(255, 102);
            v8 = sub_02023790(255, 102);
            v9 = sub_0200B1EC(param1->unk_14.unk_34, 99);

            sub_020238A0(v8, (v5 + v4 + 1), 2, 1, 1);
            sub_02023D28(v7, param1->unk_8B4.unk_1D58[v5 + v4]->unk_00.unk_00);
...
void ov62_0223331C (UnkStruct_ov62_02233310 *param0, UnkStruct_0208C06C * param1, int param2)
{
    ...
    UnkStruct_02002F38 * v6 = param1->unk_14.unk_14;
...
static UnkStruct_0200D0F4 *ov62_0223352C (UnkStruct_ov62_0223359C *param0, UnkStruct_0208C06C * param1, int param2, int param3)
{
    UnkStruct_0200D0F4 * v0;
    UnkStruct_ov104_0223F9E0 v1;
...
static void ov62_02233B50 (UnkStruct_ov62_02233F74 *param0, UnkStruct_0208C06C * param1)
{
...

    {
...

        {
            ...
            if (v13 != 0) {
                v10 = &param0->unk_3C[2];
                v6 = sub_02023790(255, 102);
                v7 = sub_0200B1EC(param1->unk_14.unk_34, 9);
                v8 = sub_02023790(255, 102);

                sub_020238A0(v6, v13, 4, 0, 1);
                sub_0200B48C(v9, 0, v6, 0, 1, GAME_LANGUAGE);
                sub_0200C388(v9, v8, v7);
                sub_0201ADA4(v10, 0x0);
                sub_0201D78C(v10, 0, v8, ov62_0223429C(v10, v8), 0, 0xff, ((u32)(((15 & 0xff) << 16) | ((13 & 0xff) << 8) | ((0 & 0xff) << 0))), NULL);
...

        {
            ...
            u64 v15 = v14;
            u32 v16[3];
            UnkStruct_02023790 * v17 = sub_02023790(255, 102);
            UnkStruct_02023790 * v18 = sub_02023790(255, 102);
            UnkStruct_02023790 * v19 = sub_02023790(255, 102);
            ...
            sub_020238A0(v17, v16[0], 5, 2, 1);
            sub_020238A0(v18, v16[1], 5, 2, 1);
            sub_020238A0(v19, v16[2], 2, 2, 1);
...
static void ov62_02234440 (UnkStruct_0208C06C *param0)
{
    ...
    if (param0->unk_41D8.unk_00 == 1) {
        if (param0->unk_41D8.unk_0C) {
            sub_0200DA58(param0->unk_41D8.unk_0C);
        }
