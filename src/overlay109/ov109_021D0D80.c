...
static void ov109_021D24F8(UnkStruct_ov109_021D0F70 *param0)
{
    ...
    v1->unk_04 = MessageLoader_Init(MESSAGE_LOADER_BANK_HANDLE, NARC_INDEX_MSGDATA__PL_MSG, TEXT_BANK_SPIN_TRADE, HEAP_ID_95);
    ...
    v1->unk_6C = String_New(0x100, HEAP_ID_95);

    for (v0 = 0; v0 < 5; v0++) {
        param0->unk_2C.unk_6C[v0] = String_New(7 + 1, HEAP_ID_95);
    }
...
static void ov109_021D268C(UnkStruct_ov109_021D0F70 *param0, u32 param1, const TrainerInfo *param2)
{
    ...
    v0 = String_New(0x100, HEAP_ID_95);
