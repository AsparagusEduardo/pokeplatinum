...
BOOL sub_0202F298(SaveData *saveData, int heapID, int *param2, FieldBattleDTO *param3, int param4)
{
    ...
    Unk_021C07A4 = SaveData_BattleRecording(saveData, heapID, param2, param4);
...
BOOL sub_0202F330(SaveData *saveData, int heapID, int *param2, int param3)
{
    UnkStruct_0202F298 *v0;
    UnkStruct_0202F41C *v1;
    BattleRecording *v2 = SaveData_BattleRecording(saveData, heapID, param2, param3);
