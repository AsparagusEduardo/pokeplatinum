...
static int PokemonSummaryScreen_Init(ApplicationManager *appMan, int *state)
{
    ...
    PokemonSummaryScreen *summaryScreen = OverlayManager_NewData(appMan, sizeof(PokemonSummaryScreen), HEAP_ID_POKEMON_SUMMARY_SCREEN);

    memset(summaryScreen, 0, sizeof(PokemonSummaryScreen));

    summaryScreen->data = OverlayManager_Args(appMan);
...
static int PokemonSummaryScreen_Main(ApplicationManager *appMan, int *state)
{
    PokemonSummaryScreen *summaryScreen = OverlayManager_Data(appMan);
