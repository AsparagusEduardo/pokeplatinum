        ...
        if (v2 >= 4) {
            ...
            if (v2 < 2) {
                if (v0->unk_20 == 1) {
                    ...
                    v9 = ((8 + 2)) + (sub_0201D35C() % ((112 - (2 * 2)) - v7));
                    v10 = ((16 + 2)) + (sub_0201D35C() % ((129 - (2 * 2)) - v8));
                } else {
                    v9 = v0->unk_1C;
                    v10 = v0->unk_1E;
                }
...
static void ov22_02258D4C (UnkStruct_ov22_02258A48 *param0)
{
    ...
    if (v0->unk_10 != NULL) {
        if ((Unk_021BF67C.unk_5C != 0xffff) && (Unk_021BF67C.unk_5C != 0xffff)) {
            v1 = Unk_021BF67C.unk_5C - v0->unk_14;
            v2 = Unk_021BF67C.unk_5E - v0->unk_18;
...
static void ov22_02258DAC (UnkStruct_ov22_02258A48 *param0)
{
    ...
    if (v0->unk_10 != NULL) {
        if ((Unk_021BF67C.unk_5C != 0xffff) && (Unk_021BF67C.unk_5C != 0xffff)) {
            ...
            v3 = Unk_021BF67C.unk_5C - v0->unk_14;
            v4 = Unk_021BF67C.unk_5E - v0->unk_18;
