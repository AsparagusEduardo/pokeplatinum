...
{
    *param1 = PokemonSprite_GetAttribute(param0->unk_2C.unk_4C.monSprite, MON_SPRITE_X_CENTER);
    *param2 = PokemonSprite_GetAttribute(param0->unk_2C.unk_4C.monSprite, MON_SPRITE_Y_CENTER);
}
...
void ov22_02257D70(UnkStruct_ov22_02257964 *param0, GXRgb param1)
{
    ...
    while (v0 != &param0->unk_00.unk_14) {
        if (v0->unk_04 == 0) {
            ...
            PokemonSprite_SetAttribute(v2->monSprite, MON_SPRITE_DIFFUSE_R, (param1 >> 10) & 0x1f);
            PokemonSprite_SetAttribute(v2->monSprite, MON_SPRITE_DIFFUSE_G, (param1 >> 5) & 0x1f);
            PokemonSprite_SetAttribute(v2->monSprite, MON_SPRITE_DIFFUSE_B, (param1 >> 0) & 0x1f);
        }
