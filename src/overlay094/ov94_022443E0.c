...
{
    param0->unk_B8.monData = ov94_022411DC(param0->unk_00->party, param0->unk_00->pcBoxes, param0->unk_110, param0->unk_112);
    ...
    PokemonSummaryScreen_SetPlayerProfile(&param0->unk_B8, param0->unk_00->trainerInfo);
