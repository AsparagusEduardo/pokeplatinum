...
static void ov94_0223D88C(UnkStruct_ov94_0223FD4C *param0, int param1, int param2, int param3, u16 param4, Pokemon *param5)
{
    ...
    v0 = MessageLoader_GetNewString(param0->unk_B90, param1);
...
void ov94_0223D910(MessageLoader *param0, MessageLoader *param1, StringTemplate *param2, Window param3[], BoxPokemon *boxMon, UnkStruct_ov94_0223BA88_sub2 *param5)
{
    ...
    v3 = MessageLoader_GetNewString(param0, 70);
    v1 = MessageLoader_GetNewString(param0, Unk_ov94_02245FD8[gender]);

    StringTemplate_SetNumber(param2, 3, level, 3, 0, 1);

    v2 = MessageUtil_ExpandedString(param2, param0, 102, HEAP_ID_62);
...
void ov94_0223DA78(MessageLoader *param0, Window param1[], u16 *param2, Pokemon *param3, Window param4[])
{
    ...
    v1 = MessageLoader_GetNewString(param0, 48);
    String_CopyChars(v0, param2);

    v2 = MessageLoader_GetNewString(param0, 172);
    Pokemon_GetValue(param3, MON_DATA_OTNAME_STRING, v3);
