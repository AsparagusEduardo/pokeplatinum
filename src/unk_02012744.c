...
typedef struct UnkStruct_02012CE0_t {
...
static void sub_02012CD0(UnkStruct_02012CE0 *param0);
static UnkStruct_02012CE0 * sub_02012CE0(const UnkStruct_02012744 * param0);
...
static void sub_02013088(const UnkStruct_020127E8 * param0, const UnkStruct_02013034 * param1, const NNSG2dImageProxy * param2, UnkStruct_02012CE0 * param3);
...
static void sub_020130DC(UnkStruct_02012CE0 *param0);
...
UnkStruct_02012744 *sub_02012744 (int param0, int param1)
{
    ...
    v0->unk_64 = param0;
    memset(v0->unk_60, 0, sizeof(UnkStruct_02012CE0) * param0);
...
void sub_02012870 (UnkStruct_02012CE0 *param0)
{
    GF_ASSERT(param0);
...
void sub_020128C4 (UnkStruct_02012CE0 *param0, int param1, int param2)
{
    int v0;
    VecFx32 v1;
    const VecFx32 * v2;
...
void sub_02012938 (UnkStruct_02012CE0 *param0)
{
    int v0;
    VecFx32 v1;
    const VecFx32 * v2;
...
void sub_020129A4 (const UnkStruct_02012CE0 * param0, int * param1, int * param2)
{
    GF_ASSERT(param0);
    GF_ASSERT(param1);
    GF_ASSERT(param2);
...
void sub_020129D0 (UnkStruct_02012CE0 *param0, BOOL param1)
{
    int v0;
...
void sub_02012A00 (UnkStruct_02012CE0 *param0, u8 param1)
{
    int v0;
...
void sub_02012A30 (UnkStruct_02012CE0 *param0, u32 param1)
{
    int v0;
...
void sub_02012A60 (UnkStruct_02012CE0 *param0, u32 param1)
{
    int v0;
...
void sub_02012A90 (UnkStruct_02012CE0 *param0, u32 param1)
{
    int v0;
...
void sub_02012AC0 (UnkStruct_02012CE0 *param0, u32 param1)
{
    int v0;
...
void sub_02012AF0 (UnkStruct_02012CE0 *param0, GXOamMode param1)
{
    int v0;
...
UnkStruct_02012CE0 *sub_02012B60 (const UnkStruct_020127E8 * param0, const UnkStruct_02012B20 * param1)
{
    UnkStruct_02012CE0 * v0;
    NNSG2dImageProxy * v1;
...
void sub_02012BD8 (UnkStruct_02012CE0 *param0)
{
    sub_02012870(param0);
}

void sub_02012BE0 (UnkStruct_02012CE0 *param0, const UnkStruct_02012B20 * param1, const UnkStruct_0205AA50 * param2, int param3)
{
    int v0;
    char * v1;
    NNSG2dImageProxy * v2;
...
static void sub_02012CD0 (UnkStruct_02012CE0 *param0)
{
    memset(param0, 0, sizeof(UnkStruct_02012CE0));
}
...
void sub_020131E0 (UnkStruct_02012CE0 *param0, const UnkStruct_02022550 * param1)
{
