...
int ov116_022609B4(ApplicationManager *param0, int *param1)
{
    UnkStruct_ov116_0226139C *v0;

    Heap_Create(HEAP_ID_APPLICATION, HEAP_ID_106, 0x65000);
    v0 = OverlayManager_NewData(param0, sizeof(UnkStruct_ov116_0226139C), HEAP_ID_106);
...
int ov116_02260CF4(ApplicationManager *param0, int *param1)
{
...
int ov116_0226126C(ApplicationManager *param0, int *param1)
{
    switch (*param1) {
    case 0: {
        u32 v0;
