...
BOOL sub_02049EC4(u16 param0, SaveData *saveData, u8 param2)
{
    ...
    for (i = 0, v2 = 0; i < partyCount; i++) {
        ...
        if (param2 == 1) {
            if (sub_02049D38(v8, species, item, v2) == 1) {
                continue;
            }
        }

        v8[v2].unk_00 = species;
        v8[v2].unk_02 = item;
        v2++;
    }
...
u16 sub_02049FF8(SaveData *saveData, u16 param1)
{
    ...
    if (param1 == 6) {
        v0 = sub_02030698(sub_0203068C(saveData), 113, sub_0205E6A8(113));
        return v0;
    }

    v0 = sub_02030698(sub_0203068C(saveData), 1 + param1 * 2, 0xff);
...
u16 sub_0204A064(SaveData *saveData)
{
    ...
    if (v0 == 6) {
        sub_020306E4(sub_0203068C(saveData), 100, sub_0205E6A8(100), 0);
    } else {
        sub_0202D414(v3, 8 + v0, 2);
    }

    sub_0202D3B4(v3, v0, 2);
    sub_020306E4(sub_0203068C(saveData), sub_0205E750(v0), sub_0205E6A8(sub_0205E750(v0)), 0);
...
UnkStruct_0204AFC4 *sub_0204A124(SaveData *saveData, u16 param1, u16 param2)
{
    ...
    if (v3->unk_0F != 5) {
        v4 = sub_0203068C(saveData);
        v5 = SaveData_GetGameRecordsPtr(saveData);
...
BOOL sub_0204A378(UnkStruct_0204AFC4 *param0, void **param1, SaveData *saveData)
{
    ...
    v2 = Party_GetFromSavedata(saveData);
...
int sub_0204A410(UnkStruct_0204AFC4 *param0, SaveData *saveData)
{
    ...
    for (v0 = 0; v0 < param0->unk_0E; v0++) {
        mon = Party_GetPokemonBySlotIndex(party, param0->unk_2A[v0]);
        v2[v0] = Pokemon_GetValue(mon, MON_DATA_SPECIES, NULL);
        v3[v0] = Pokemon_GetValue(mon, MON_DATA_HELD_ITEM, NULL);
...
static void sub_0204A5EC(UnkStruct_0204AFC4 *param0, SaveData *saveData, u8 param2, u16 param3)
{
    ...
    case 1:
        if (param3 >= 7) {
            sub_0206CFE4(SaveData_TVBroadcast(saveData), param2, param3);
        }
        break;
    case 4:
...
void sub_0204A660(UnkStruct_0204AFC4 *param0, SaveData *saveData)
{
    ...
    int v1;
    u16 v2, v3, v4;
    GameRecords *v5 = SaveData_GetGameRecordsPtr(saveData);
    UnkStruct_0203068C *v6 = sub_0203068C(saveData);
    ...
    if (param0->unk_0F == 6) {
        v4 = sub_02030698(sub_0203068C(saveData), 100, sub_0205E6A8(100));
    } else {
    ...
    if (param0->unk_0F != 6) {
        GameRecords_AddToRecordValue(SaveData_GetGameRecordsPtr(saveData), RECORD_UNK_015, 1);
    }
...
void sub_0204A7A4(UnkStruct_0204AFC4 *param0, SaveData *saveData, JournalEntry *journalEntry)
{
    ...
    v6 = SaveData_GetGameRecordsPtr(saveData);
    v7 = sub_0203068C(saveData);
    ...
    if (param0->unk_0F == 6) {
        v5 = sub_02030698(sub_0203068C(saveData), 100, sub_0205E6A8(100));
    } else {
    ...
    if (param0->unk_0F == 6) {
        sub_020306E4(sub_0203068C(saveData), 100, sub_0205E6A8(100), 1);
    } else {
...
u16 sub_0204ABF4(UnkStruct_0204AFC4 *param0, SaveData *saveData)
{
    ...
    if (param0->unk_0F == 6) {
        v0 = sub_02030698(sub_0203068C(saveData), 100, sub_0205E6A8(100));
    } else {
...
static u16 sub_0204AC54(SaveData *saveData, u8 param1, UnkStruct_0204AFC4 *param2)
{
    ...
    v3 = Party_GetFromSavedata(saveData);
    v1 = 0;
