...
int ov98_02246C20(ApplicationManager *param0, int *param1);
int ov98_02246C98(ApplicationManager *param0, int *param1);
int ov98_02246DC0(ApplicationManager *param0, int *param1);
...
#endif // POKEPLATINUM_OV98_02246C20_H
