...
int ov70_0225D9A4(ApplicationManager *param0, int *param1);
int ov70_0225DB90(ApplicationManager *param0, int *param1);
int ov70_0225DDF8(ApplicationManager *param0, int *param1);
...
#endif // POKEPLATINUM_OV70_0225D9A4_H
